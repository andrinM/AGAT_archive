...
""" This algorithm uses a list as input, not a data frame
"""
...
must_link = [(29, 25), (28, 5), (0, 12), (12,0)]
cannot_link = [(14,26)]
clusters, centers = cop_kmeans(dataset=input_matrix, k=10, cl=cannot_link, ml=must_link)#, ml=must_link,cl=cannot_link

grouped_members = members
grouped_members["cluster"] = clusters

print(grouped_members.sort_values(by = "cluster"))
print(centers)"""